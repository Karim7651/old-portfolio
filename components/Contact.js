  ...
  import {
    ...
    useClipboard,
    useColorModeValue,
    VStack, MenuButton, Menu, MenuItem, MenuList, Center
  ...
  export default function ContactFormWithSocialButtons() {
    ...
    const [selectedValue, setSelectedValue] = useState("Type of enquiry");
    ...
    const handleSubmit = () => {
      ...
      if (!name || !email || !message || selectedValue === 'Type of enquiry') {
        setShowAlert(true);
        return;
      }
      ...
      axios.post('https://api.web3forms.com/submit', {
        access_key: '077f965c-c291-42db-a2e8-db1b9ec3081f',
        name,
        email,
        selectedValue,
        message
    ...
    return (
      <Flex
        ...
        id="contact" maxWidth={'99vw'} m = '0'>
        <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 16 }} minWidth='94.5vw' minHeight={'100vh'}>
          <Box>
                  ...
                  <VStack spacing={5}>
                    <FormControl isRequired>
                      ...
                      <InputGroup>
                        ...
                        <Input type="text" name="name" placeholder="Your Name" position={'Center'} value={name} onChange={handleChange} />
                      </InputGroup>
                    </FormControl>
                    ...
                    <FormControl isRequired>
                      ...
                      <Menu >
                        ...
                        <MenuList name={'menu'}>
                          <MenuItem  value="Freelance project proposal" name={'menu'} onClick={handleChange}>
                            Freelance project proposal
                          </MenuItem >
                          <MenuItem  value="Other" name={'menu'} onClick={handleChange}>
                            Other
                          </MenuItem>
                        </MenuList>
                      </Menu>
